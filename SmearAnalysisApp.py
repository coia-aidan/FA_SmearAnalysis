...
import FAscript23 as script


layout = [[sg.Text("Prepare files in ProSize: ",s=(80,1),font='Georgia',text_color='cyan2',background_color='midnight blue')],
	  [sg.Text("Ensure min. peak height is set so that main peak is the first peak after the lower marker for all samples. (Peak 1=LowerMarker, Peak 2=MainPeak)",size=(120,1),font='Georgia',text_color='cyan2',background_color='midnight blue')],
...
window = sg.Window('Smear Analysis', layout,resizable=True, text_justification = 'center',
